          ...
          {active === item && children && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                transition={transition}
                layoutId="active"
                className="bg-gray-900 backdrop-blur-sm rounded-2xl overflow-hidden border border-black/[0.2] shadow-xl"
              >
  ...
  return (
    <a href={href} className="flex space-x-2">
      ...
      <div>
        ...
        <p className="text-gray-300 text-sm max-w-[10rem]">{description}</p>
      </div>
    </a>
  );
};
